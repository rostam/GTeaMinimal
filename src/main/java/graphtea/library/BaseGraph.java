...
abstract public class BaseGraph<VertexType extends BaseVertex, EdgeType extends BaseEdge<VertexType>>
     ...
     * @see BaseGraph#getVerticesCount()
     */
     ...
     * @throws InvalidVertexException the vertex is invalid
     * @see BaseGraph#getDegree(BaseVertex)
     */
     ...
     * @see BaseGraph#lightEdgeIterator(BaseVertex)
     * @see BaseGraph#getNeighbors(BaseVertex)
     */
     ...
     * @see ListGraph#lightBackEdgeIterator(BaseVertex)
     */
